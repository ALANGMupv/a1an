...
# 1. Gazebo - mundo con TurtleBot3 burger_cam
...
# 2. Localizacion - mapa
echo -e "${GREEN}[2/6] Lanzando Localizacion...${NC}"
...
echo -e "${GREEN}Todo lanzado. WebSocket: ws://localhost:9090 | Camara: http://localhost:8080/stream?topic=/camera/image_raw${NC}"
