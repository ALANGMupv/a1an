...
class NavigateToPoseClient(Node):
    ...
    def send_goal(self, x, y, theta=0.0):
        ...
        goal_pose.pose.orientation.w = 1.0  # orientación hacia adelante
    ...
    def feedback_callback(self, feedback_msg):
        ...
        Args:
            feedback_msg: Mensaje con la distancia restante al goal.
        """
...
def main(args=None):
    ...
    Parsea los argumentos de línea de comandos (x, y), inicializa ROS 2
    y lanza el cliente de navegación.
    """
